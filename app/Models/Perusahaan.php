...
class Perusahaan extends Model
{
    ...
    public function createCoaForPerusahaan()
    {
        ...
        DB::table('coa')->insert([
            ...
            ['kode_akun' => '5101', 'nama_akun' => 'Harga Pokok Penjualan', 'kelompok_akun' => '5', 'posisi_d_c' => 'Debit', 'saldo_awal' => 0, 'id_perusahaan' => $this->id_perusahaan, 'created_at' => now(), 'updated_at' => now()],
